...
namespace NBomberXUnitTests
{
    public class QuickPizzaTests
    {
        ...
        public void QuickPizza_Homepage_Should_Meet_Performance_Thresholds()
        {
            ...
            var scenarioStats = stats.ScenarioStats.FirstOrDefault(s => s.ScenarioName == "quickpizza_homepage");
        ...
        [Fact]
        public void QuickPizza_Homepage_Should_Fail_If_Too_Slow()
        {
            var httpClient = new HttpClient();
            ...
            Assert.True(p95 < 20, $"P95 latency too high: {p95} ms");
            Assert.True(failRate < 0.02, $"Failure rate too high: {failRate:P2}");
        }
    }
}
